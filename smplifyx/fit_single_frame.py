...
def fit_single_frame(img,
    ...
    if use_vposer:
        ...
        vposer, _ = load_model(vposer_ckpt, model_code=VPoser, remove_words_in_model_weights='vp_model.')
    ...
    if use_vposer:
        ...
        body_pose_shape = body_model.body_pose.shape[-1]
        body_mean_pose = torch.zeros([batch_size, body_pose_shape], dtype=dtype) #body_pose_prior.get_mean().detach().cpu()
